...
add_action( 'after_setup_theme', '<%= themePrefix %>_custom_background_setup', 15 );
 ...
 * @return void
 */
function <%= themePrefix %>_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => '<%= themePrefix %>_custom_background_callback',
		)
	);
}
 ...
 * @return void
 */
function <%= themePrefix %>_custom_background_callback() {
